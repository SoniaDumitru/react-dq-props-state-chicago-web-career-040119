    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog data={offspring[0]} eyecolor={this.state.eyeColor}/>
          <BabyHog data={offspring[1]} eyecolor={this.state.eyeColor}/>
          <BabyHog data={offspring[2]} eyecolor={this.state.eyeColor}/>
        </ul>
